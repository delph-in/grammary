...
### The program takes as input the file lexicon.tdl. It
...
### the lexicon.
### The output is written to types-rel.tdl (it is only relevant for the Hebrew lexicon
### and rels; for Arabic, use ara-create_rel_hier.py).
###
### To work on the big files, comment out the first two lines of code, and uncomment
### the next two.
...
###
heb_lexicon = open('../lexicon.tdl','r')
rels_file = open('../types-rel.tdl','w')

#heb_lexicon = open('../lexicon_big.tdl','r')
#rels_file = open('../types-rel_big.tdl','w')
